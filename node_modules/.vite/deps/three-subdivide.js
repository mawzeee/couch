...
var LoopSubdivision = class _LoopSubdivision {
  ...
  static modify(bufferGeometry, iterations = 1, params = {}) {
    ...
    if (params.split === void 0) params.split = true;
    if (params.uvSmooth === void 0) params.uvSmooth = false;
    if (params.preserveEdges === void 0) params.preserveEdges = false;
    if (params.flatOnly === void 0) params.flatOnly = false;
    if (params.maxTriangles === void 0) params.maxTriangles = Infinity;
    if (params.weight === void 0) params.weight = 1;
  ...
  static smooth(geometry, params = {}) {
    ...
    function addEdgePoint(posHash, edgeHash) {
      if (!existingEdges[posHash]) existingEdges[posHash] = /* @__PURE__ */ new Set();
    ...
    attributeList.forEach((attributeName) => {
      ...
      if (existingAttribute === void 0 || flattenedAttribute === void 0) return;
